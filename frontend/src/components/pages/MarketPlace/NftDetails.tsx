        ...
        <div className=" flex flex-wrap gap-5 h-full">
          <div className="container mx-auto px-4 h-full pt-5">
              ...
              <div className="w-3/5">
                <div className=" w-full flex flex-col gap-y-5 p-2">
                  ...
                  <div className="h-full w-full mt-7 pr-10">
                    <h1 className="text-2xl font-medium text-neutral mb-5">
                      Description
                    </h1>
                  ...
                  <div className=" h-full w-full">
                    <h1 className="text-2xl font-medium text-neutral mt-7 mb-7">
                      Latest bids
                    </h1>
                                ...
                                <tr key={i}>
                                  ...
                                  <td className="flex flex-col items-end">
                                    <p className="font-bold text-sm">
                                      {ethers.utils.formatEther(bid.amount)} ETH
                                    </p>
                  ...
                  <div className="h-full w-full">
                    <h1 className="text-2xl font-medium text-neutral my-10">
                      Details
                    </h1>
            ...
            <div className="mt-32 flex flex-col items-center mb-32">
              <h1 className="text-2xl font-medium text-neutral mb-20">
