...
export default function SalesComponant( {nft, showLoading, 
    setShowLoading, 
    setShowModalSucces, 
    setTransactionHash, 
    ethPrice,
    ...
    <div className="mt-7 items-center justify-between w-full space-y-4 border-t py-4 sm:flex-row sm:space-y-0 border-gray-300 border px-5 rounded-xl ">
            ...
            <div className="w-full my-2">
                ...
                <div className="">
                    ...
                    <div className="flex flex-row items-center space-x-2">
                        ...
                        <div className="stat-title pt-1">= {(ethPrice * nft.price).toFixed(3)} $ </div>
                    </div>
                </div>
        ...
        <div className="w-full flex flex-row items-center justify-center  space-x-2 pt-5">
            ...
            { nft && nft.listEndTime ? <Countdown date={ Date.now() + nft.listEndTime } /> : <p> 00:00:00:00</p> }
