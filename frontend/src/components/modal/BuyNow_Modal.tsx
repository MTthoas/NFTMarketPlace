      ...
      <div className="relative my-6 mx-auto max-w-3xl w-3/5 xl:w-2/5 2xl:w-1/5">
        ...
        <div className="border-0 rounded-lg shadow-lg relative flex flex-col bg-white outline-none focus:outline-none">
          ...
          <div className="flex items-start justify-between p-6 rounded-t">
            ...
            <button
              className="p-1 pb-1 ml-auto border-0 text-black float-right text-2xl leading-none font-semibold outline-none focus:outline-none"
          ...
          <div className='px-6 font-medium text-sm text-gray-500 '>
                <p> You are about to buy <span className='text-black'> {nft.name} #{nft.tokenId} . </span> </p>
          </div>
