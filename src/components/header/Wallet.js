                ...
                >
                    ...
                    <div className="relative w-full h-full max-w-md md:h-auto">
                        <div className="relative  rounded-lg shadow ">
                            <button type="button" className="absolute top-3 right-2.5 text-gray-900 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm p-1.5 ml-auto inline-flex items-center dark:hover:bg-gray-800 dark:hover:text-white" data-modal-hide="crypto-modal">
                              <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6"  onClick={closeModal}>
                            ...
                            <div className="p-6">
                                ...
                                <ul className="my-4 space-y-3">
                                    <li>
                                        <a href="#" className="flex items-center p-3 text-base font-medium text-gray-900 rounded-lg bg-gray-50 hover:bg-gray-100 group hover:shadow dark:bg-gray-600 dark:hover:bg-gray-500 dark:text-white">
                                            ...
                                            <span className="flex-1 ml-3 whitespace-nowrap text-gray-900" onClick={connectMetamask}>MetaMask </span>
                                    ...
                                    <li>
                                      <a href="#" className="flex items-center p-2 text-base font-medium text-gray-900 rounded-lg bg-gray-50 hover:bg-gray-100 group hover:shadow dark:bg-gray-600 dark:hover:bg-gray-500 ">
                                          ...
                                          <span className="flex-1 ml-3 whitespace-nowrap text-gray-900" >Coinbase Wallet</span>
                                      </a>
                                    </li>
                                    <li>
                                      <a href="#" className="flex items-center py-3 pl-2 text-base font-medium text-gray-900 rounded-lg bg-gray-50 hover:bg-gray-100 group hover:shadow dark:bg-gray-600 dark:hover:bg-gray-500 dark:text-white">
                                    <img src={WalletConnectPng} className="w-8" alt="logo" />
                                    <span className="flex-1 ml-1 whitespace-nowrap text-gray-900">WalletConnect</span>
                                      </a>
                                  </li>
