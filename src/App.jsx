        ...
        <main className="drawer-content flex flex-col bg-base-100">
          ...
          <div className="h-screen w-full">
            ...
            <div className="container px-4 py-7 mx-auto">
              <h2 className="text-2xl text-center font-semibold text-white pt-5 pb-7">Create and Sell Your NFTs</h2>
              <div className='flex flex-col md:flex-row justify-around gap-10 md:gap-20'>
                <div className='flex flex-col items-center justify-center h-full'>
                  ...
                  <h3 className='text-xl font-bold text-center py-2'>Setup your wallet</h3>
                  <p className='text-center'>Once you’ve set up your wallet of choice, connect it to ArtX by clicking the wallet icon in the navigation menu</p>
                </div>
                <div className='flex flex-col items-center justify-center h-full'>
                  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-16 h-16">
                    <path strokeLinecap="round" strokeLinejoin="round" d="M3 16.5v2.25A2.25 2.25 0 005.25 21h13.5A2.25 2.25 0 0021 18.75V16.5m-13.5-9L12 3m0 0l4.5 4.5M12 3v13.5" />
                  </svg>
                  <h3 className='text-xl font-bold text-center py-2'>Upload & Create Collection</h3>
                  <p className='text-center'>Once you’ve set up your wallet of choice, connect it to ArtX by clicking the wallet icon in the navigation menu</p>
                </div>
                <div className='flex flex-col items-center justify-center h-full'>
                  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-16 h-16">
                  ...
                  <h3 className='text-xl font-bold text-center py-2'>List them for sale</h3>
                  <p className='text-center'>Upload your work then Click My Collections and set up your collection. Add social links and a description to your NFTs</p>
                </div>
